...
### Changed)
Jan-12 - Trying a serverless referral marketing solution - trying to Netlify toml file in the parent directory (library.wwfm-dsap.com points to subdirectory /static/library which is where the file was)  
